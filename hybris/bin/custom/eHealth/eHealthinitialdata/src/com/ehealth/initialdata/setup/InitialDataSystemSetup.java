 ...
 *
 */
package com.ehealth.initialdata.setup;
...
import com.ehealth.initialdata.constants.EHealthInitialDataConstants;
 ...
 */
@SystemSetup(extension = EHealthInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		hybrisImportData.setProductCatalogName(EHEALTH);
		hybrisImportData.setContentCatalogNames(Arrays.asList(EHEALTH));
		hybrisImportData.setStoreNames(Arrays.asList(EHEALTH));
