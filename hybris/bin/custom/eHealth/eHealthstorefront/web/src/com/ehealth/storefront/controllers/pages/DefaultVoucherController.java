package com.ehealth.storefront.controllers.pages;
...
public class DefaultVoucherController extends AbstractPageController
{
			...
			final HttpServletRequest request)
	{
		try
		{
			...
			/*
			 * promotionGroup = promotionsService.getPromotionGroup("eHealthPromoGrp"); final List<PromotionGroupModel>
	...
	public String releaseVoucher()
	{
		try
		{
			...
			modelService.save(cartService.getSessionCart());
			promotionGroup = promotionsService.getPromotionGroup("eHealthPromoGrp");
