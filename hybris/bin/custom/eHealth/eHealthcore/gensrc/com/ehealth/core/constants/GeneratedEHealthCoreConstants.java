 ...
 * ----------------------------------------------------------------
 */
package com.ehealth.core.constants;
...
public class GeneratedEHealthCoreConstants
{
	public static final String EXTENSIONNAME = "eHealthcore";
	...
	public static class Attributes
	{
		...
		{
			public static final String ACCESSORIES = "accessories".intern();
			public static final String COMINGSOON = "comingSoon".intern();
	...
	protected GeneratedEHealthCoreConstants()
	{
		// private constructor
	}
