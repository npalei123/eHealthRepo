 ...
 * ----------------------------------------------------------------
 */
package com.eHealth.eHealthcommerceservices.jalo;

import com.eHealth.eHealthcommerceservices.constants.EHealthcommerceservicesConstants;
import com.eHealth.jalo.ProductQuantityThresholdFreeGiftPromotion;
...
/**
 * Generated class for type <code>EHealthcommerceservicesManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedEHealthcommerceservicesManager extends Extension
{
	...
	public ProductQuantityThresholdFreeGiftPromotion createProductQuantityThresholdFreeGiftPromotion(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( EHealthcommerceservicesConstants.TC.PRODUCTQUANTITYTHRESHOLDFREEGIFTPROMOTION );
	...
	{
		return EHealthcommerceservicesConstants.EXTENSIONNAME;
	}
